...
create index if not exists idx_CR_DEVICE_AREA2device_id on CR_DEVICE_AREA(device_id);
...
create index if not exists idx_CE_PORT_EQUIPPORT2related_equipment on CE_PORT_EQUIPPORT(related_equipment);
create index if not exists idx_CM_LINK_TRANSO2zh_label on CM_LINK_TRANSO(zh_label);
create index if not exists idx_CM_PORT_FIBER2zh_label on CM_PORT_FIBER(zh_label);
create index if not exists idx_CM_LINK_TRANSO2start_equipport_id on CM_LINK_TRANSO(start_equipport_id);
create index if not exists idx_CM_LINK_TRANSO2end_equipport_id on CM_LINK_TRANSO(end_equipport_id);
-- ----------------------------
...
-- ----------------------------
-- Function structure for proc_checkonecoordinateindex
-- ----------------------------
...
begin
   ...
   --指标值
	 ...
	 insert into dims_tm_taskItem_index(name,code,task_id,index_id,collectionDate,province,
		                                  amount,errorAmount,indexValue,creator,updater)
	 values(v_idxName,v_idxCode,p_taskId,p_indexId,v_collectionDate,v_province,
...
-- ----------------------------
-- Function structure for proc_checkonecriticalareacodeindex
-- ----------------------------
...
-- ----------------------------
-- Function structure for proc_checkonecriticalnotnullindex
-- ----------------------------
...
begin
   ...
   if v_extensionAttr is not null and v_coretable <> v_extensiontable then
...
-- ----------------------------
-- Function structure for proc_checkonedictaccuracyindex
-- ----------------------------
...
-- ----------------------------
-- Function structure for proc_checkoneexttableassocindex
-- ----------------------------
...
-- ----------------------------
-- Function structure for proc_checkonemandatoryclassifiedindex
-- ----------------------------
...
-- ----------------------------
-- Function structure for proc_checkonerelationkeyindex
-- ----------------------------
...
begin
   ...
   select name,code,amountSql,errorSql
	   into v_idxName,v_idxCode,v_amountSql,v_errorSql
     From dims_idx_index
    where id=p_indexId;
...
-- ----------------------------
-- Function structure for proc_checkonerepeatabilityindex
-- ----------------------------
...
create or replace function proc_checkIndexSet(p_taskId integer) returns void as
$$
declare
   cur                record;
   v_collectionDate   timestamp;
