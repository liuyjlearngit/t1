...
create table VOLTE_POOL(int_id varchar(500), zh_label varchar(500), pool_type varchar(500), contain_devices text, cover_city varchar(500), related_ims_pool_id varchar(500), dims_col_result text,dims_col_rtName text);
...
create table IMS_POOL(int_id varchar(500), zh_label varchar(500), pool_type varchar(500), contain_ne_names text, cover_area varchar(500), related_ims_pool_id varchar(500), dims_col_result text,dims_col_rtName text);
...
create table PS_POOL(int_id varchar(500), zh_label varchar(500), pool_type varchar(500), contain_devices text, cover_area varchar(500), dims_col_result text,dims_col_rtName text);
...
create or replace function   is_not_valid_ipaddress(ip varchar) returns bool as
$$
declare
begin
