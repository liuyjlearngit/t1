...
'update RM_AREA_SITE t1
                   set dims_col_result=(case when dims_col_result like ''%area04r01%'' then dims_col_result
                                             ...
                                             else dims_col_result||'',area04r01'' end),
                       dims_col_rtName=(case when dims_col_rtName like ''%站点经纬度范围合规性核查%'' then dims_col_rtName
                                             when dims_col_rtName is null then ''不满足规范:站点经纬度范围合规性核查''
                                             else dims_col_rtName||'',站点经纬度范围合规性核查'' end)
...
'update RM_AREA_RESPOINT t1
                   set dims_col_result=(case when dims_col_result like ''%area04r02%'' then dims_col_result
                                             ...
                                             else dims_col_result||'',area04r02'' end),
                       dims_col_rtName=(case when dims_col_rtName like ''%位置点经纬度范围合规性核查%'' then dims_col_rtName
                                             when dims_col_rtName is null then ''不满足规范:位置点经纬度范围合规性核查''
                                             else dims_col_rtName||'',位置点经纬度范围合规性核查'' end)
                 where not exists(select 1
                                from RM_AREA_ROOM t2
                               where  t1.equiproom_id = t2.int_id
