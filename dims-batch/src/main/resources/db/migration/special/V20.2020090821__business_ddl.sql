...
int_id varchar(500),zh_label varchar(500),business_status varchar(500),address_segment_name varchar(500),equipment_id varchar(500),port_id varchar(500),address_business_syst varchar(500),ip_address_type varchar(500),province_id varchar(500),city_id varchar(500),county_id varchar(500), dims_col_result text,    dims_col_rtName	text  
);
