 ...
 * @date      16. April 2008
 * @version   $Id: ext-ux-lovcombo.js,v 1.1 2012-02-24 15:54:21 wusuirong Exp $
 *
 * @license ext-ux-lovcombo.js is licensed under the terms of the Open Source
...
Ext.ux.form.LovCombo = Ext.extend(Ext.form.ComboBox, {
  ...
  , initComponent: function () {
    ...
    if (!this.tpl) {
      this.tpl =
        '<tpl for=".">'
        + '<div class="x-combo-list-item"  qtip="{toolTip}">'//{toolTip:ellipsis(15)}
        + '<img src="' + Ext.BLANK_IMAGE_URL + '" '
        + 'class="ux-lovcombo-icon ux-lovcombo-icon-'
        //+'{[values.' + this.checkField + '?"checked":values.' + this.checkField + '===null?"mixed":"unchecked"' + ']}">'
        + '{[values.' + this.checkField + '?"checked":"unchecked"' + ']}">'
        + '<div class="ux-lovcombo-item-text">{' + (this.displayField || 'text') + ':ellipsis(30)}</div>'
        + '</div>'
        + '</tpl>'
      ;
    }
